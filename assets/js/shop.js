...
class ShopManager {
  ...
  async fetchMockProducts() {
    ...
    return [
      ...
      {
        id: 1,
        name: "Premium Leather Earrings - Gold Collection",
        category: "leather",
        price: 900,
        originalPrice: 1200,
        image: "./assets/img/leather/Premium Leather Earrings1.jpeg",
        description:
          "Elegant handmade leather earrings with intricate Egyptian patterns. Lightweight and comfortable for daily wear.",
        featured: true,
        inStock: true,
        artisan: "Fatima Ali",
        tags: ["earrings", "leather", "handmade", "jewelry", "gold"]
      },
      {
        id: 2,
        name: "Premium Leather Earrings - Silver Collection",
        category: "leather",
        price: 900,
        originalPrice: 1200,
        image: "./assets/img/leather/Premium Leather Earrings2.jpeg",
        description:
          "Beautiful silver-toned leather earrings featuring traditional Egyptian motifs. Perfect for any occasion.",
        featured: false,
        inStock: true,
        artisan: "Fatima Ali",
        tags: ["earrings", "leather", "handmade", "jewelry", "silver"]
      },
      {
        id: 3,
        name: "Premium Leather Earrings - Turquoise",
        category: "leather",
        price: 900,
        originalPrice: null,
        image: "./assets/img/leather/Premium Leather Earrings3.jpeg",
        description:
          "Stunning turquoise leather earrings inspired by ancient Egyptian jewelry.",
        featured: false,
        inStock: true,
        artisan: "Fatima Ali",
        tags: ["earrings", "leather", "handmade", "jewelry", "turquoise"]
      },
      {
        id: 4,
        name: "RANO Natural Leather - Classic Brown",
        category: "leather",
        price: 2400,
        originalPrice: 3000,
        image: "./assets/img/leather/RANO Natural Leather1.jpeg",
        description:
          "Premium natural leather handcrafted with traditional Egyptian techniques. Durable and stylish.",
        featured: true,
        inStock: true,
        artisan: "RANO Atelier",
        tags: ["bag", "leather", "natural", "handmade", "brown"]
      },
      {
        id: 5,
        name: "RANO Natural Leather - Black Edition",
        category: "leather",
        price: 2400,
        originalPrice: 3000,
        image: "./assets/img/leather/RANO Natural Leather2.jpeg",
        description:
          "Sleek black natural leather accessory showcasing Egyptian craftsmanship.",
        featured: false,
        inStock: true,
        artisan: "RANO Atelier",
        tags: ["bag", "leather", "natural", "handmade", "black"]
      },
      {
        id: 6,
        name: "RANO Natural Leather - Tan",
        category: "leather",
        price: 2400,
        originalPrice: null,
        image: "./assets/img/leather/RANO Natural Leather3.jpeg",
        description:
          "Warm tan natural leather piece with authentic Egyptian design elements.",
        featured: false,
        inStock: true,
        artisan: "RANO Atelier",
        tags: ["bag", "leather", "natural", "handmade", "tan"]
      },
      {
        id: 7,
        name: "LAILA Premium Leather Bag",
        category: "leather",
        price: 3750,
        originalPrice: 4500,
        image: "./assets/img/leather/LAILA Premium Leather Bag.jpeg",
        description:
          "Exquisite premium leather bag by LAILA, featuring elegant design and superior craftsmanship. Spacious and perfect for daily use.",
        featured: true,
        inStock: true,
        artisan: "LAILA Design",
        tags: ["bag", "leather", "premium", "handbag", "luxury"]
      },
      {
        id: 8,
        name: "LAILA Premium Leather Card Holder",
        category: "leather",
        price: 1250,
        originalPrice: 1600,
        image: "./assets/img/leather/LAILA Premium Leather Card holder1.jpeg",
        description:
          "Slim and stylish leather card holder by LAILA. Perfect for carrying your essential cards in elegance.",
        featured: false,
        inStock: true,
        artisan: "LAILA Design",
        tags: ["card holder", "leather", "wallet", "accessory"]
      },
      {
        id: 9,
        name: "LAILA Premium Leather Pierce",
        category: "leather",
        price: 2250,
        originalPrice: 2800,
        image: "./assets/img/leather/LAILA Premium Leather Pierce1.jpeg",
        description:
          "Unique leather pierce accessory combining modern style with Egyptian heritage.",
        featured: false,
        inStock: true,
        artisan: "LAILA Design",
        tags: ["pierce", "leather", "accessory", "handmade"]
      },
      {
        id: 10,
        name: "ROSE Bag Ethes",
        ...
        price: 3300,
        originalPrice: 4000,
        image: "./assets/img/leather/ROSE Bag Ethes.jpeg",
        description:
          "Elegant ROSE bag with intricate leatherwork and traditional Egyptian patterns.",
        featured: true,
        inStock: true,
        artisan: "ROSE Collection",
        tags: ["bag", "leather", "rose", "handbag", "elegant"]
      },
      {
        id: 11,
        name: "ROSE Bracelet",
        ...
        price: 400,
        originalPrice: 600,
        image: "./assets/img/leather/ROSE Bracelet.jpeg",
        description:
          "Delicate leather bracelet from ROSE collection. Lightweight and comfortable.",
        featured: false,
        inStock: true,
        artisan: "ROSE Collection",
        tags: ["bracelet", "leather", "jewelry", "rose"]
      },
      {
        id: 12,
        name: "ROSE Glasses Holder",
        category: "leather",
        price: 600,
        originalPrice: 800,
        image: "./assets/img/leather/ROSE Glasses Holder.jpeg",
        description:
          "Protective leather glasses case with elegant ROSE design.",
        featured: false,
        inStock: true,
        artisan: "ROSE Collection",
        tags: ["glasses case", "leather", "accessory", "rose"]
      },
      {
        id: 13,
        name: "ROSE Keys Holder",
        category: "leather",
        price: 400,
        originalPrice: 550,
        image: "./assets/img/leather/ROSE Keys Holder.jpeg",
        description:
          "Compact leather key holder to organize your keys in style.",
        featured: false,
        inStock: true,
        artisan: "ROSE Collection",
        tags: ["key holder", "leather", "accessory", "rose"]
      },
      {
        id: 14,
        name: "ROSE Large Bag",
        ...
        price: 3750,
        originalPrice: 4600,
        image: "./assets/img/leather/ROSE Large bag.jpeg",
        description:
          "Spacious large leather bag from ROSE collection, perfect for daily use and travel.",
        featured: true,
        inStock: true,
        artisan: "ROSE Collection",
        tags: ["bag", "leather", "large", "handbag", "rose"]
      },
      {
        id: 15,
        ...
        price: 1000,
        originalPrice: 1300,
        image: "./assets/img/leather/ROSE Passport holder.jpeg",
        description:
          "Stylish leather passport holder to keep your travel documents safe and organized.",
        featured: false,
        inStock: true,
        artisan: "ROSE Collection",
      ...
      },
      {
        ...
        price: 1250,
        originalPrice: 1600,
        image: "./assets/img/leather/ROSE Pierce.jpeg",
        description:
          "Elegant leather pierce accessory from the ROSE collection.",
        featured: false,
        inStock: true,
        artisan: "ROSE Collection",
        tags: ["pierce", "leather", "accessory", "rose"]
      },
      {
        id: 17,
        name: "ROSE Small Bag",
        ...
        price: 2500,
        originalPrice: 3100,
        image: "./assets/img/leather/ROSE Small Bag.jpeg",
        description:
          "Charming small leather bag perfect for evenings and special occasions.",
        featured: false,
        inStock: true,
        artisan: "ROSE Collection",
        tags: ["bag", "leather", "small", "handbag", "rose"]
      },
      {
        id: 18,
        name: "ROSE Small Bag - Brown",
        category: "leather",
        price: 2400,
        originalPrice: 3000,
        image: "./assets/img/leather/ROSE Small bag1.jpeg",
        description:
          "Beautiful brown leather small bag with traditional Egyptian details.",
        featured: false,
        inStock: true,
        artisan: "ROSE Collection",
        tags: ["bag", "leather", "small", "handbag", "brown"]
      },
      {
        id: 19,
        name: "ROSE Small Pierce",
        category: "leather",
        price: 600,
        originalPrice: 800,
        image: "./assets/img/leather/ROSE Small Pierce.jpeg",
        description:
          "Delicate small leather pierce accessory for everyday elegance.",
        featured: false,
        inStock: true,
        artisan: "ROSE Collection",
        tags: ["pierce", "leather", "small", "accessory"]
      }
    ];
  }
